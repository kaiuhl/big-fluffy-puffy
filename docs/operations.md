...
cached HTTP/3 alternative service entry can discard it. Production TLS is
temporarily pinned to TLS 1.2 while diagnosing Chrome/Zscaler connection
failures; remove that pin once the middlebox path is understood.
