...
class RodaApp < Roda
  ...
  SITE_CSS_PATH = "/styles/site.css?v=20260716-wildfire-dark-panel-1".freeze
  FIRE_RESTRICTIONS_JS_PATH = "/scripts/fire-restrictions.js?v=20260715-wildfire-overlay-1".freeze
